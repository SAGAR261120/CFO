...
const getTheme = (mode: 'light' | 'dark') => {
  ...
  const classes: ThemeClasses = {
    ...
    // New container to align Tabs and Buttons in one line
    topNavigation: {
      display: 'flex',
    ...
    tabsContainer: {
      display: 'flex',
      gap: '24px',
      marginBottom: '-1px', // Push items down 1px so border overlaps parent border
      overflowX: 'auto',
    },
    buttonGroup: {
      display: 'flex',
      gap: '12px',
      paddingBottom: '8px', // Visual alignment with tabs text
    },
    btnBase: {
      display: 'flex',
      alignItems: 'center',
...
export function Settings() {
  ...
  return (
    <div style={classes.wrapper}>
      ...
      {/* TOP NAVIGATION (TABS + BUTTONS) */}
      <div style={classes.topNavigation}>
